...
```
    ...
    ✅ Configuration loaded. Run ID: 20251010_182439
...
print("Does SAVE_DIR exist?", os.path.exists(SAVE_DIR))
print("Files currently in SAVE_DIR:", os.listdir(SAVE_DIR) if os.path.exists(SAVE_DIR) else "None")
```
    ...
    Cell In[12], line 2
          1 print("SAVE_TO_FILE =", SAVE_TO_FILE)
    ----> 2 print("SAVE_DIR =", SAVE_DIR)
          3 print("Does SAVE_DIR exist?", os.path.exists(SAVE_DIR))
          4 print("Files currently in SAVE_DIR:", os.listdir(SAVE_DIR) if os.path.exists(SAVE_DIR) else "None")
